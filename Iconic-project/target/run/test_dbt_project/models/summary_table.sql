  ...
  create  table "postgres"."public"."summary_table__dbt_tmp"
  as (
...
WITH base AS (
    ...
    FROM "postgres"."public"."transaction_journey" AS t
    LEFT JOIN "postgres"."public"."stg_products" AS p ON t.item_id = p.item_id
    GROUP BY 1
)
